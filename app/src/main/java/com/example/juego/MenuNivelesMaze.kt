...
class MenuNivelesMaze : AppCompatActivity() {
    ...
    private val descripciones= arrayOf(
        R.string.muralla, R.string.cenizales, R.string.pueblo, R.string.necro, R.string.barrio
    )
        ...
        for (i in niveles.indices) {
            val imageView = ImageView(this).apply {
                ...
                setOnClickListener {
                    ...
                    sharedPref.edit().putString("descripcion", getString(descripciones[i])).apply()
